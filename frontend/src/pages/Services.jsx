...
const Services = () => {
  ...
  return (
    <div
  id="services"
  className="min-h-screen bg-gradient-to-b from-white to-gray-50 text-[#0f172a] overflow-hidden pb-20"
>
      ...
      <section className="px-4 py-10 max-w-7xl mx-auto">
        ...
        <h2 className={`text-3xl md:text-4xl font-[700] mb-12 text-[#0f172a] text-center`}>
          Our Services
        </h2>
        </ScrollReveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            <div 
              className={`bg-white rounded-2xl border border-gray-200 hover:border-blue-300 transition-all duration-700 overflow-hidden group hover:shadow-xl hover:scale-105`}
            >
              ...
              <div className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-[700] text-[#0f172a]">{service.title}</h3>
                </div>
      ...
      <section className="px-4 py-12 max-w-4xl mx-auto">
        <ScrollReveal direction="up" delay={0.1}>
        <h2 className={`text-3xl font-[700] mb-12 text-center text-[#0f172a]`}>Our Process</h2>
        </ScrollReveal>
            ...
            {processSteps.map((step, index) => (
              ...
              >
                <div className={`absolute left-0 w-16 h-16 rounded-full flex items-center justify-center ${index === 3 ? 'bg-gradient-to-r from-blue-600 to-purple-600' : 'bg-white border-2 border-blue-500'} shadow-lg`}>
                  {index === 3 ? getIconComponent('check', 'text-white w-6 h-6') : <span className="text-lg font-[700] text-blue-600">{step.number}</span>}
                </div>
                <div>
                  <h4 className="text-xl font-[700] mb-2 text-[#0f172a]">{step.title}</h4>
